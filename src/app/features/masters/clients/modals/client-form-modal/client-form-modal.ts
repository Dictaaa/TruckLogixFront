...
export class ClientFormModal implements OnInit {
  ...
  private dialogRef = inject(MatDialogRef<ClientFormModal>);
  ...
  save(): void {
    ...
    const request$ = this.isEdit
      ? this.api.putAuth(ENDPOINTS.CLIENTS.UPDATE(this.data.id), payload)
      : this.api.postAuth(ENDPOINTS.CLIENTS.CREATE, payload);
