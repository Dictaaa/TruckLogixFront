...
export class Sidebar {
  ...
  masterItems: NavItem[] = [
    ...
    },
    {
      ...
      icon: `<svg viewBox="0 0 24 24"><path d="M3 17l4-8 4 4 3-6 4 10"/><path d="M3 21h18"/></svg>`
    },
    {
      label: 'Clientes',
      route: '/clients',
    ...
    },
    {
      label: 'Conductores',
      route: '/drivers',
      icon: `<svg viewBox="0 0 24 24"><circle cx="12" cy="8" r="4"/><path d="M3 21a9 9 0 0 1 18 0"/></svg>`
    },
    {
      label: 'Contenedores',
      route: '/containers',
      icon: `<svg viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M2 12h20M12 7v14"/></svg>`
    },
    {
      label: 'Operaciones',
      route: '/operations',
      icon: `<svg viewBox="0 0 24 24"><path d="M9 3H5a2 2 0 0 0-2 2v4m6-6h10a2 2 0 0 1 2 2v4M9 3v18m0 0h10a2 2 0 0 0 2-2v-4M9 21H5a2 2 0 0 1-2-2v-4m0 0h18"/></svg>`
    },
    {
      label: 'Patios',
      route: '/yards',
    ...
    },
    {
      label: 'Vehículos',
      route: '/vehicles',
      icon: `<svg viewBox="0 0 24 24"><rect x="2" y="14" width="18" height="8" rx="2"/><path d="M6 14V10a2 2 0 0 1 2-2h7l4 4"/><circle cx="7" cy="22" r="2"/><circle cx="17" cy="22" r="2"/></svg>`
    },
    {
      label: 'Usuarios',
      route: '/users',
