...
export class Sidebar {
  ...
  // mainItems filtrados según rol
  get filteredMainItems(): NavItem[] {
    if (this.isRole4) {
      // Rol 4 solo ve Dashboard, no Movimientos
      return this.mainItems.filter(i => i.route === '/dashboard');
    }
    return this.mainItems;
  }

  // masterItems filtrados según rol
  get filteredMasterItems(): NavItem[] {
    if (this.isRole4) {
      // Rol 4 solo ve Combustible
